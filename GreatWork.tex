...
\\In this thesis, the flow and transport through micro-vessels in the capillary range is the main concern, where generally the time-dependent velocity of blood will be neglected. The main approximation is a steady-state flow rate. This means that there is no variation of velocity depending on time for a given point in the network
...
\\Steady-State approximation for simulations.
