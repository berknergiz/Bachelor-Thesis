...
\begin{figure}[h]
\centering
\includegraphics[width=180mm]{tracer_1}
\caption{\footnotesize $DuMu^x$ Tracer Simulation for a Rectangular Geometry}
\label{fig:tracer_1}
\end{figure}
Figure \ref{fig:nephron_velocity}  is the result of a $DuMu^x$ tracer simulation computed on a rectangular geometry. The solute field in the network for the last time step is visualized.\\
