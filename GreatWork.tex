...
This thesis aimed to understand and specify how, using computational methods, blood flow and oxygen transport can be simulated using different methods. For this, two approaches have been presented \ref{Greens}, \ref{$DuMu^x$} and the results or outlooks have been discussed \ref{Results}.\\
