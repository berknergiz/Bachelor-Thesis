...
\end{figure}
\\Obviously looking at the Contour plot doesn't make much sense here, as the high number of vessels makes an analysis of the $PO_2$ distribution in the tissue impossible. For this reason, other files must be used but which ones ?
...
Put one or two new networks from Kartik in and analyze the results like for the previous networks.
